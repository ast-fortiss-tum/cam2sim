...
OUTPUT_RAW = os.path.join(OUTPUT_DIR, "detections_raw.json")
OUTPUT_REFINED = os.path.join(OUTPUT_DIR, "ground_truth_refined.json")
OUTPUT_CLUSTERS_TXT = os.path.join(OUTPUT_DIR, "final_clusters.txt")
OUTPUT_BB_TXT = os.path.join(OUTPUT_DIR, "ground_truth_bboxes.txt")
...
def main():
    ...
    print("DONE!")
    print("=" * 70)
    print(f"  Raw detections:     {OUTPUT_RAW}")
